...
export class Setting {
  ...
  addControl(fn: any) { const c: any = { setValue(v: any) { this.value = v; return this; }, setDisabled(v: boolean) { this.disabled = v; return this; }, addOptions(v: any) { this.options = v; return this; }, setButtonText(v: string) { this.text = v; return this; }, onChange(fn: any) { this.change = fn; return this; }, onClick(fn: any) { this.click = fn; return this; } }; fn(c); Setting.controls.push(c); return this; }
