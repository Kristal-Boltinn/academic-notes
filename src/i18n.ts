...
export const ENGLISH = {
  ...
  "浅色模式主色": "Light-mode accent",
  "深色模式主色": "Dark-mode accent",
  "浅色模式角标颜色": "Light-mode motif color",
  "深色模式角标颜色": "Dark-mode motif color",
  "跟随默认配色": "Use default colors",
  "角标图案": "Corner motif",
  "原有图案": "Original motif",
  "无角标": "No motif",
  "月桂": "Laurel", "罗盘": "Compass", "花章": "Rosette", "轨道": "Orbit", "晶格": "Lattice", "编结": "Knot", "拱廊": "Arcade", "羽笔": "Quill", "书页": "Folio",
  "Proof 与 Remark 保持无框段落；自定义主色只改变标题，Proof 的结束方框保持不变。": "Proof and Remark remain borderless paragraphs. Accent overrides change their titles; the proof's end square is unchanged.",
  "主色同步用于标题底色、边框和浅色同色系背景；标题文字自动选择黑色或白色。角标默认跟随主色。": "The accent controls the title background, border and pale matching fill. Title text automatically uses black or white. Motifs inherit the accent unless overridden.",
  "这是当前模式下的外观预览。": "Preview of this environment in the current mode.",
  "恢复此环境默认外观": "Reset this environment's appearance",
  "恢复默认": "Reset to default",
  "边框粗细、圆角、角标大小与透明度可在 Style Settings → Academic Notes 调整；圆角 0 为直角。": "Adjust border width, corner radius, motif size and opacity in Style Settings → Academic Notes. A radius of 0 gives square corners.",
  "插入学术环境": "Insert academic environment",
  "在此填写标题": "Enter a title",
  "在此填写正文": "Enter content here",
  "子图数量须为 2–12。": "Choose between 2 and 12 subfigures.",
  "子图": "Subfigure",
  "在当前行前插入完整环境，保留原文；插入后直接填写选中的标题。": "Insert a complete environment before the current line, preserving existing text. The title is selected for editing.",
  ...
  "子图组": "Subfigure group",
  "表格": "Table",
  "子图数量": "Subfigure count",
  "最大列数": "Maximum columns",
  "自动": "Auto",
  "自动：四幅最多四列，其余最多三列；窄窗格会减少列数，四列直接变两列。": "Auto: four images use up to four columns; other groups use up to three. Narrow panes reduce columns; four columns switch directly to two.",
  "统一图片高度（像素）": "Shared image height (pixels)",
  "留空保留各图片宽度；设置后整组等高，不拉伸、不裁剪，空间不足时整组统一缩小。": "Leave blank to preserve individual image widths. Images share a height without cropping or stretching; narrow groups scale all images down together.",
  "高度须为 16–1200 的整数，或留空。": "Enter a whole-number height from 16 to 1200, or leave blank.",
  "插入": "Insert",
